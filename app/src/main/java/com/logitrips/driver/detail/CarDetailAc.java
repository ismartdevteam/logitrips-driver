...
//import com.logitrips.driver.model.Car;
...
//        String dayStr = getResources().getQuantityString(R.plurals.day, (int) interval.toDuration().getStandardDays(), (int) interval.toDuration().getStandardDays());
