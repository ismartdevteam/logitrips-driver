...
public class Utils {
    ...
    public static final String[] dest_str = {"Bali"};
    public static final String[] lang_arr = {"Any", "English", "Japanese"," Chinese", "Korean", "Russian", "Arabic",
            "German", "Italian", "Malay"};
    public static final String[] add_hours = {"1", "2", "3", "4", "5", "10"};
    public static final String[] pick_up_location = {"Ngurah Rai airport", "Denpasar", "Jimbaran", "Kuta", "Nusa Dua", "Padangbai", "Sanur", "Seminyak", "Ubud"};
    public static final String[] payment_status = {"Not paid", "Paid", "Payment confirmed", "Payment failed"};
    public static final String[] trip_status = {"Booked", "Car confirmed", "Car declined", "Canceled", "Finished"};
