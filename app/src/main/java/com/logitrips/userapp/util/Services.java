...
public class Services {
    public static void register(final Bundle b, final Activity ac, final int type, final String name, final String email, final String password, final String phone, final String country, final String profile_pic_url) {
    ...
    public static void login(final Bundle b,final Activity ac, final String email, final String password) {
                ...
                try {
                    switch (response.getInt("response")) {
                        case 200:
                            ...
                            ac.finish();
                            Intent intent = new Intent(ac, MenuAc.class);
                            intent.putExtras(ac.getIntent().getExtras());
                            ac.startActivity(intent);
                            break;
                        case 300:
